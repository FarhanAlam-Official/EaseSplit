    ...
    switch (requiredRole) {
      ...
      case 'member':
        return { 
          ...
          description: 'This page is restricted to group members only.',
          icon: UserCheck,
          color: 'text-blue-500',
      ...
      case 'owner':
        return { 
          title: 'Group Owner Access Required', 
          description: 'This page is restricted to group owners only.',
          icon: Lock,
